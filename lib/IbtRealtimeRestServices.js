 ...
 * @param {int} Max value
 */
exports.saveAuthentication = function (connectionUrl, authenticationToken, authenticationTokenIsPrivate, applicationKey, timeToLive, privateKey, permissions, callback) {
...
exports.enablePresence = function(parameters,callback){
...
exports.disablePresence = function(parameters,callback){
    var url = urlApi.parse(parameters.url);
...
exports.getPresence = function(parameters,callback){
    var url = urlApi.parse(parameters.url);
